...
**Status:** pre-submission freeze candidate; no live score is claimed
...
| Consequence | stop gained; LoF-compatible | missense; candidate hypomorph |
...
### 3.4 Incomplete raw-read k-mer check

Four incomplete FASTQ prefixes totaling 14.03 GB compressed and 179,097,018 readable records were scanned only as partial QC. Unique centered allele-1 k-mers showed alternate/reference counts of 2/6 at k=31 and 2/5 at k=51; allele 2 showed 0/3 and 0/2. Because every input prefix was incomplete and the alternate allele was not observed for allele 2, this result is inconclusive, received zero ranking weight, and is not presented as variant confirmation.
...
## 9. Dataset citation and required acknowledgement
